...
const Info = ({ show }: { show: boolean }) => {
  return (
    <div className={`results ${styles.info}`} style={{ display: show ? 'block' : 'none' }}>
      <h2>What is this..?</h2>
      <p>
      ...
      <h2>Fineli</h2>
      <p>
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Nobis est cum
        ad totam ducimus cupiditate. Voluptatum quisquam pariatur modi dolor.
        Repudiandae at quibusdam dicta inventore, atque quod earum recusandae
        id!
      </p>
      <h2>USDA</h2>
      <p>
        ...
        debitis quae porro incidunt! Iusto rerum deserunt autem, fuga dolor ipsa
        excepturi et molestiae ullam sit suscipit repellendus, at, illum
        corporis velit vel sed porro consequuntur quo harum facilis? Eos
        accusamus dolore porro ipsam hic! Ratione, libero quos! Laborum dolorem
        nesciunt, sapiente odio numquam provident deleniti minima est illo
        corporis sequi cupiditate qui dolore optio vel eaque?
      </p>
    </div>
  );
};
